...
export const scriptLines_ProductsTable = {
    ...
    productsTable: {
        toasts: {
            fieldUpdateSuccess: "Product field '{{fieldKey}}' updated.",
            fieldUpdateError: "Failed to update {{fieldKey}}.",
            statusUpdateSuccess: "Product status updated to {{status}}.",
            statusUpdateError: "Failed to update status.",
            deleteSuccess: "Product '{{productName}}' deleted successfully.",
            deleteError: "Failed to delete '{{productName}}'.",
