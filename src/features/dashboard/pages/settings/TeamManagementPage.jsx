...
const TeamListSkeleton = () => (
    <div className="space-y-4 animate-pulse">
        {[...Array(3)].map((_, i) => (
            <div key={i} className="flex items-center justify-between p-4 border border-neutral-200 dark:border-neutral-700 rounded-lg">
...
const TeamManagementPage = () => {
    ...
    const { data: members, isLoading, isError, error } = useBusinessMembers(user?.activeBusinessId);
    ...
    const inviteMutation = useMutation({
        ...
        onSuccess: () => {
            ...
            queryClient.invalidateQueries(queryKeys.businessMembers(user.activeBusinessId));
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <div>
                    ...
                    <p className="text-neutral-600 dark:text-neutral-400 mt-1">
                        Invite and manage members of your business.
                    </p>
                </div>
                {canManageTeam && (
                    <Button
            ...
            <div className="border-t border-neutral-200 dark:border-neutral-700 pt-6">
                ...
                {members && (
                    <ul className="space-y-3">
                        {members.map((member) => (
                            <li key={member.id} className="flex items-center justify-between p-3 -mx-3 rounded-lg transition-colors hover:bg-neutral-50 dark:hover:bg-neutral-700/50">
                                <div className="flex items-center">
            ...
            <Modal isOpen={isInviteModalOpen} onClose={() => setIsInviteModalOpen(false)}>
                <form onSubmit={handleInviteSubmit} className="p-1">
                    ...
                    <p className="text-sm text-neutral-500 dark:text-neutral-400 mt-1 mb-4">
                        They will receive an email to join your business.
                    </p>
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="block w-full rounded-md border-neutral-300 dark:border-neutral-600 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm bg-white dark:bg-neutral-700 text-neutral-900 dark:text-neutral-100"
                            >
                    ...
                    <div className="mt-6 flex justify-end gap-3">
                        ...
                        <Button type="submit" variant="solid" color="primary" isLoading={inviteMutation.isLoading}>
                            Send Invite
                        </Button>
                    </div>
                </form>
