...
export const scriptLines_dashboard = {
    ...
    nav: {
        ...
        venue: i18n.t('dashboard.dashboard.nav.venue'),
    ...
    actionItemsCard: {
        ...
        confirmNewOrders: i18n.t('dashboard.dashboard.actionItemsCard.confirmNewOrders'),
    ...
    productMoversCard: {
        ...
        periodMonth: i18n.t('data_cards.WORDS.Month'),
        topItemsTitle: i18n.t('dashboard.dashboard.productMoversCard.topItemsTitle'),
    ...
    businessSwitcher: {
        ...
        failedToLoad: i18n.t('dashboard.dashboard.businessSwitcher.failedToLoad'),
        createNewBusiness: i18n.t('dashboard.dashboard.businessSwitcher.createNewBusiness'),
        upgradePlanTooltip: i18n.t('dashboard.dashboard.businessSwitcher.upgradePlanTooltip'),
    ...
    subscriptionBadge: {
        ...
        cancelsOn: i18n.t('dashboard.dashboard.subscriptionBadge.cancelsOn'),
        actionRequired: i18n.t('dashboard.dashboard.subscriptionBadge.actionRequired'),
        trialEndsToday: i18n.t('dashboard.dashboard.subscriptionBadge.trialEndsToday'),
        trialDaysLeft: i18n.t('dashboard.dashboard.subscriptionBadge.trialDaysLeft'),
        growthPlan: i18n.t('dashboard.dashboard.subscriptionBadge.growthPlan'),
        premiumPlan: i18n.t('dashboard.dashboard.subscriptionBadge.premiumPlan'),
    ...
    createBusinessPage: {
        ...
        businessNamePlaceholder: i18n.t('dashboard.dashboard.createBusinessPage.businessNamePlaceholder'),
        businessEmailLabel: i18n.t('dashboard.dashboard.createBusinessPage.businessEmailLabel'),
        businessEmailPlaceholder: i18n.t('dashboard.dashboard.createBusinessPage.businessEmailPlaceholder'),
        businessPhoneLabel: i18n.t('dashboard.dashboard.createBusinessPage.businessPhoneLabel'),
        businessPhonePlaceholder: i18n.t('dashboard.dashboard.createBusinessPage.businessPhonePlaceholder'),
        cancelButton: i18n.t('venue_management.cancel'),
        createButton: i18n.t('dashboard.dashboard.createBusinessPage.createButton'),
        toastSuccess: i18n.t('dashboard.dashboard.createBusinessPage.toastSuccess'),
    ...
    inventoryPage: {
        ...
        buttonPlaceholder: i18n.t('dashboard.dashboard.inventoryPage.buttonPlaceholder'),
    ...
    ordersPage: {
        ...
        buttonPlaceholder: i18n.t('dashboard.dashboard.ordersPage.buttonPlaceholder'),
        tablePlaceholderTitle: i18n.t('dashboard.dashboard.ordersPage.tablePlaceholderTitle'),
    ...
    commissionsList: {
        ...
        headerCommission: i18n.t('dashboard.dashboard.commissionsList.headerCommission'),
    ...
    referralsList: {
        ...
        headerDate: i18n.t('dashboard.dashboard.commissionsList.headerDate'),
        headerBusiness: i18n.t('dashboard.dashboard.commissionsList.headerBusiness'),
        headerSubscription: i18n.t('dashboard.dashboard.referralsList.headerSubscription'),
