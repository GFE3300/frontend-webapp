// src/features/dashboard/cards/at_a_glance/RevenueSnapshot.jsx
...
const RevenueSnapshot = ({ data }) => {
    const { current_value = "0.00", comparison_percentage = 0, comparison_label = "" } = data || {};
    const { user } = useAuth();
    ...
    return (
        <div className="flex flex-col justify-between h-full p-4">
            <div>
                <p className="text-sm font-semibold text-neutral-500 dark:text-neutral-400">Revenue Today</p>
                <p className="text-4xl font-bold text-purple-600 dark:text-purple-400 mt-1">
                    {formatCurrency(parseFloat(current_value), user?.activeBusinessCurrency)}
                </p>
            </div>
