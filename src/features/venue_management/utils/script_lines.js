...
export const scriptLines = {
    ...
    currencyFormat: i18n.t('venue_management.currencyFormat'), // "{symbol}{amount}"
    currencyCode: i18n.t('register.steps.step4Preferences.options.currencies.0.value'), // "USD"
    ...
    venueManagement: {
        liveOrderDashboard: {
            ...
            totalPriceLabel: i18n.t('venue_management.venueManagement.liveOrderDashboard.totalPriceLabel'), // "Total: {price}"
        ...
        venueDesignerHeader: {
            ...
            qrButtonText: i18n.t('venue_management.venueManagement.venueDesignerHeader.qrButtonText'), // "QRs"
        ...
        layoutEditor: {
            ...
            mainRegionLabel: i18n.t('venue_management.venueManagement.layoutEditor.canvasAreaLabel'), // "Layout Design Canvas Area"
            propertiesInspectorRegionLabel: i18n.t('venue_management.venueManagement.layoutEditor.propertiesInspectorRegionLabel'), // "Item Properties Inspector"
            ...
            validationErrorTitle: i18n.t('venue_management.venueManagement.layoutEditor.validationErrorTitle'), // "Layout Validation Error"
        ...
        editorToolbar: {
            ...
            elementsCategory: i18n.t('venue_management.venueManagement.editorToolbar.elementsCategory'), // "Elements"
            ...
            subdivisionOptionSuffix: i18n.t('venue_management.venueManagement.editorToolbar.subdivisionOptionSuffix'), // "x{value}"
            ...
            saveButtonText: i18n.t('venue_management.save'), // "Save"
        ...
        editorCanvas: {
            mainCanvasAreaLabel: i18n.t('venue_management.venueManagement.editorCanvas.mainCanvasAreaLabel'), // "Venue Layout Design Canvas"
            gridRegionLabel: i18n.t('venue_management.venueManagement.editorCanvas.gridRegionLabel'), // "Layout Grid Area"
            resizePreviewAriaHidden: i18n.t('venue_management.venueManagement.editorCanvas.resizePreviewAriaHidden'), // "true"
            // If resize preview itself had text (it doesn't currently), that would go here.
        },
        canvasCell: {
            gridCellRoleDescription: i18n.t('venue_management.venueManagement.canvasCell.gridCellRoleDescription'), // "Layout grid cell"
        ...
        placedItem: {
            ...
            itemBaseTitle: i18n.t('venue_management.venueManagement.placedItem.itemBaseTitle'), // "{itemName}"
            itemFixedSuffix: i18n.t('venue_management.venueManagement.placedItem.itemFixedSuffix'), // "(Fixed)"
            itemProvisionalSuffix: i18n.t('venue_management.venueManagement.placedItem.itemProvisionalSuffix'), // "(Provisional - Click in Editor to set number)"
            itemMoveCandidateSuffix: i18n.t('venue_management.venueManagement.placedItem.itemMoveCandidateSuffix'), // "Click a cell to move {itemName}"
            ...
            itemDefaultAriaRole: i18n.t('venue_management.venueManagement.placedItem.itemDefaultAriaRole'), // "button"
        },
        resizeHandle: {
            tooltipPrefix: i18n.t('venue_management.venueManagement.resizeHandle.tooltipPrefix'), // "Resize {direction}"
        ...
        propertiesInspector: {
            ...
            itemPropertiesTitleSuffix: i18n.t('venue_management.venueManagement.propertiesInspector.defaultTitle'), // "Properties"
            ...
            minimizedTabTooltip: i18n.t('venue_management.venueManagement.propertiesInspector.minimizedTabTooltip'), // "Show Properties"
            mobilePeekTitleSuffix: i18n.t('venue_management.venueManagement.propertiesInspector.defaultTitle'), // "Properties"
            ...
            defaultInspectorContent_rendererMissingText: i18n.t('venue_management.venueManagement.placedItem.defaultRendererMissingText'), // "Renderer Missing"
        ...
        tableEditor: {
            ...
            seatsTooltip: i18n.t('venue_management.venueManagement.tableEditor.seatsTooltip'), // "Enter a number or leave empty for default seats."
            seatsHelpText: i18n.t('venue_management.venueManagement.tableEditor.seatsTooltip'), // "Enter a number or leave empty for default seats."
            infoSectionTitle: i18n.t('venue_management.venueManagement.tableEditor.infoSectionTitle'), // "Table Information"
        ...
        wallEditor: {
            ...
            infoSectionTitle: i18n.t('venue_management.venueManagement.wallEditor.infoSectionTitle'), // "Wall Information"
            itemIdLabel: i18n.t('venue_management.venueManagement.tableEditor.itemIdLabel'), // "Item ID:"
        ...
        doorEditor: {
            ...
            selectSwingPlaceholder: i18n.t('venue_management.venueManagement.doorEditor.selectSwingPlaceholder'), // "Select Swing Direction"
            infoSectionTitle: i18n.t('venue_management.venueManagement.doorEditor.infoSectionTitle'), // "Door Information"
            itemIdLabel: i18n.t('venue_management.venueManagement.tableEditor.itemIdLabel'), // "Item ID:"
            typeLabel: i18n.t('venue_management.venueManagement.doorEditor.typeLabel'), // "Type:"
            standardDoorType: i18n.t('venue_management.venueManagement.doorEditor.standardDoorType'), // "Standard Door"
            rotationLabel: i18n.t('venue_management.venueManagement.tableEditor.rotationLabel'), // "Rotation:"
            fixedLabel: i18n.t('venue_management.venueManagement.tableEditor.fixedLabel'), // "Fixed:"
            yesValue: i18n.t('venue_management.yes'), // "Yes"
            noValue: i18n.t('venue_management.no'), // "No"
        ...
        decorEditor: {
            ...
            infoSectionTitle: i18n.t('venue_management.venueManagement.decorEditor.infoSectionTitle'), // "Decor Information"
            itemIdLabel: i18n.t('venue_management.venueManagement.tableEditor.itemIdLabel'), // "Item ID:"
            decorTypeLabel: i18n.t('venue_management.venueManagement.decorEditor.decorTypeLabel'), // "Decor Type:"
            decorTypeGeneric: i18n.t('venue_management.venueManagement.decorEditor.decorTypeGeneric'), // "Generic"
        ...
        counterEditor: {
            ...
            invalidItemError: i18n.t('venue_management.venueManagement.counterEditor.invalidItemError'), // "Error: Invalid item for Counter Editor."
            infoSectionTitle: i18n.t('venue_management.venueManagement.counterEditor.infoSectionTitle'), // "Counter Information"
            itemIdLabel: i18n.t('venue_management.venueManagement.tableEditor.itemIdLabel'), // "Item ID:"
        ...
        tableRenderer: {
            ...
            provisionalDisplayValue: i18n.t('venue_management.venueManagement.tableRenderer.provisionalDisplayValue'), // "N\u00ba?"
            tableNumberPrefix: i18n.t('venue_management.venueManagement.tableRenderer.tableNumberPrefix'), // "T"
            tableNumberNotSet: "", // Value if number is null/undefined and not provisional (e.g., display only "T")
        },
        counterRenderer: {
            defaultLabel: i18n.t('venue_management.venueManagement.counterRenderer.defaultLabel'), // "Counter"
        },
        useLayoutDesignerStateManagement: {
            ...
            sizingErrorTitle: i18n.t('venue_management.venueManagement.useLayoutDesignerStateManagement.sizingErrorTitle'), // "Sizing Error"
        ...
        useQrCodeManager: {
            ...
            downloadStartingSomeUnavailable: i18n.t('venue_management.venueManagement.useQrCodeManager.downloadStartingSomeUnavailable'), // " Some QRs are unavailable or errored."
            downloadStartingSomeServiceDisabled: i18n.t('venue_management.venueManagement.useQrCodeManager.downloadStartingSomeServiceDisabled'), // " Some QRs are unavailable (service disabled)."
            downloadStartingSomeFailed: i18n.t('venue_management.venueManagement.useQrCodeManager.downloadStartingSomeFailed'), // " Some QRs previously failed to generate."
            ...
            downloadPartialMessageSuccess: i18n.t('venue_management.venueManagement.useQrCodeManager.downloadPartialMessageSuccess'), // "Successfully downloaded {downloadedCount} QR codes."
            downloadPartialMessageFailed: i18n.t('venue_management.venueManagement.useQrCodeManager.downloadPartialMessageFailed'), // " {failedCount} failed."
            downloadPartialMessageSkipped: i18n.t('venue_management.venueManagement.useQrCodeManager.downloadPartialMessageSkipped'), // " {skippedCount} skipped (service unavailable)."
        ...
        itemConfigs: {
            ...
            rectTableToolName: i18n.t('venue_management.venueManagement.itemConfigs.rectTableToolName'), // "Rect. Table"
        ...
        draggableTool: {
            ...
            tooltipDefaultZenMode: i18n.t('venue_management.venueManagement.draggableTool.tooltipDefaultZenMode'), // "{toolName}"
        ...
        venueLayoutPreview: {
            ...
            qrSeatsLabel: i18n.t('venue_management.venueManagement.venueLayoutPreview.qrSeatsLabel'), // "{seats} Seats"
            qrSeatsNotAvailable: i18n.t('venue_management.venueManagement.venueLayoutPreview.qrSeatsNotAvailable'), // "N/A Seats"
            qrShapeLabel: i18n.t('venue_management.venueManagement.venueLayoutPreview.qrShapeLabel'), // "{shape}"
            ...
            qrStatusLoading: i18n.t('venue_management.venueManagement.venueLayoutPreview.qrStatusLoading'), // "Loading QR..."
            ...
            qrErrorMessage: i18n.t('venue_management.venueManagement.venueLayoutPreview.qrErrorMessage'), // "Could not load."
            qrSkippedMessage: i18n.t('venue_management.venueManagement.venueLayoutPreview.qrSkippedMessage'), // "Unavailable."
