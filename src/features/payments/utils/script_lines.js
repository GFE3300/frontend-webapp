...
export const scriptLines_Components = {
    ...
    planSelection: { 
        ...
        plans: [
            {
                id: i18n.t('payments.components.planSelection.plans.0.id'),
            ...
            {
                id: i18n.t('payments.components.planSelection.plans.1.id'),
            ...
            {
                id: i18n.t('payments.components.planSelection.plans.2.id'),
