...
export const scriptLines_liveOrders = {
    ...
    tableLabel: i18n.t('live_orders_view.liveOrders.tableLabel'),

    guestsSummary: i18n.t('live_orders_view.liveOrders.guestsSummary'),
    
    ordersSummary: i18n.t('live_orders_view.liveOrders.ordersSummary'),
};