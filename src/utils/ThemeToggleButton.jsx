...
export const ThemeToggleButton = () => { // Exported if it's in this file, otherwise import
    ...
    return (
        <motion.button
            onClick={toggleTheme}
            className="fixed top-4 right-4 z-50 p-2 rounded-full bg-white/80 dark:bg-neutral-800/80 backdrop-blur-sm shadow-md hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors"
